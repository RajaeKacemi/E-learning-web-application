...
echo "";
$result = mysqli_query($conn,'SELECT COUNT(ui) AS no_avg FROM evaluation'); 
...
$result = mysqli_query($conn,'SELECT AVG(ui) AS ui_avg FROM evaluation'); 
$row = mysqli_fetch_assoc($result); 
...
$result = mysqli_query($conn,'SELECT AVG(performance) AS per_avg FROM evaluation'); 
$row = mysqli_fetch_assoc($result); 
...
$result = mysqli_query($conn,'SELECT AVG(design) AS des_avg FROM evaluation'); 
$row = mysqli_fetch_assoc($result); 
...
$result = mysqli_query($conn,'SELECT AVG(usablity) AS us_avg FROM evaluation'); 
$row = mysqli_fetch_assoc($result); 

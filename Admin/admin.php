  ...
  <nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
      ...
      <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#myNavbar">
        ...
        <h1 class="logo me-auto" class="navbar-brand"><a href="admin.php">LEARN CENTER</a></h1>
      </div>
    </div>
  </nav>
...
<div class="dashboard">
    ...
    <div class="adminhead">ADMIN</div><br>
    <center>
...
<br>
<form action="accountusers.php" method="get">
        <button type="submit"  class="links"><span class="glyphicon glyphicon-user"></span>Account users
    
    <!-- code og messages here -->
...
<!--    coding forum-->
       <div class="card">
        <p class="title">Contact Visits</p>
        <p class="count">
            <?php

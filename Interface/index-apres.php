...
<?php if($role==="Formateur"){
 ...
 ?>
  ...
  <a href="<?php if($role==="Formateur"){ echo '../Formateur/MyCourses.php';}else if($role==="Apprenant"){ echo '../Apprenant/CoursesApprenant.php';}  ?>" class="btn-get-started">Get Started</a>
    </div>
  </section><!-- End Hero -->
